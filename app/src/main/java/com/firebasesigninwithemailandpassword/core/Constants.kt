package com.firebasesigninwithemailandpassword.core
...
object Constants {
    ...
    //Buttons
    const val SIGN_IN_BUTTON = "Login"
    ...
    const val HOME_SCREEN = "Chat Bot"

    //Labels
    const val EMAIL_LABEL = "Email"
    const val PASSWORD_LABEL = "Password"
    const val RETYPE_PASSWORD_LABEL = "Retype Password"
    ...
    const val WELCOME_MESSAGE = "Welcome to our Chat Bot."
